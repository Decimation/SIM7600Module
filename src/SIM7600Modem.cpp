	...
	while ((comma = strchr(token, ','))) {
		*comma = '\0';
		...
		switch (index) {
			...
			case 1: sscanf(token, "%u", &gps_data.gps_satellites);
				break;
			case 2: sscanf(token, "%u", &gps_data.glonass_satellites);
				break;
			case 3: sscanf(token, "%u", &gps_data.beidou_satellites);
				break;
			case 4: sscanf(token, "%lf", &gps_data.latitude);
				break;
			case 5: n_s = token[0];
				break;
			case 6: sscanf(token, "%lf", &gps_data.longitude);
				break;
			case 7: e_w = token[0];
				break;
			case 8:
			...
			case 10: sscanf(token, "%f", &gps_data.altitude);
				break;
			case 11: sscanf(token, "%f", &gps_data.speed);
				break;
			case 12: sscanf(token, "%f", &gps_data.course);
				break;
			case 13: sscanf(token, "%f", &gps_data.pdop);
				break;
			case 14: sscanf(token, "%f", &gps_data.hdop);
				break;
		}
